...
//ending // why can't I import the code above as modules?
 ...
 */
var mySettings = {};
mySettings[ID_ON_OFF] = false;
mySettings[ID_INDEX] = INDEXNAME;
mySettings[ID_TYPE] = TYPENAME;
mySettings[ID_BLACKLIST] = convertTextToList(TEXT_BLACKDOMAINS);
mySettings[ID_BLACKTEXT] = TEXT_BLACKDOMAINS;
var defaultSettings = {...mySettings}; // clone-copy of settings
